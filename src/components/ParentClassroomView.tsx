...
export const ParentClassroomView: React.FC<ParentClassroomViewProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col justify-between gap-3">
      ...
      {isTeacher && !isSuperAdmin && (
        ...
        >
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-8 h-8 rounded-xl bg-amber-100/70 border border-amber-200/70 text-amber-700 flex items-center justify-center flex-shrink-0">
      ...
      {/* 2. Status Card */}
      <div
        className="rounded-3xl p-3.5 sm:p-4"
        style={{
          backgroundImage: 'radial-gradient(140% 140% at 0% 0%, rgba(196,181,253,0.55) 0%, rgba(196,181,253,0) 55%), radial-gradient(140% 140% at 100% 100%, rgba(94,234,212,0.50) 0%, rgba(94,234,212,0) 55%), linear-gradient(rgba(255,255,255,0.30), rgba(255,255,255,0.30))',
          backdropFilter: 'blur(20px)',
          WebkitBackdropFilter: 'blur(20px)',
              ...
              <form onSubmit={handleTeacherJoinInstitution} className="space-y-2.5 pt-1">
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  >
                    {isJoiningInst ? (
                      <>
                        <RefreshCw className="w-3.5 h-3.5 animate-spin text-sky-800" />
          ...
          >
            ...
            {(userProfile?.classCode || classroom?.code) ? (
              ...
              >
                ...
                >
                  <PlusCircle className="w-4 h-4 text-sky-800" />
